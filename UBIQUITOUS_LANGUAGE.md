...
| **Harness Verification** | The UI-facing proof loop that exercises changed scenarios and catches behavior drift beyond static inspection. | screenshotting, visual guesswork |
...
## Agentic Engineering Learning Terms
| Term | Definition | Aliases to avoid |
| --- | --- | --- |
| **Agentic Engineering** | Software work where humans and agents collaborate through explicit repo conventions, bounded tasks, validation gates, and durable source-of-truth surfaces. | vibe coding, autonomous magic |
...
- The **Standard Gate** and **Harness Verification** are proof surfaces for keeping **Contract Truth** and **Operational Truthfulness** honest.

...
function runEncoderScenario({
  ...
  try {
    ...
    const outputPreviewPath = typeof payload.output_preview === "string" ? payload.output_preview : null;
    const outputForSize = outputPreviewPath && existsSync(outputPreviewPath)
      ? outputPreviewPath
      : outputPath;

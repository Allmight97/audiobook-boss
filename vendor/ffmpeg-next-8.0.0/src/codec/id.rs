...
#[inline]
const fn codec_id_from_raw(value: u32) -> AVCodecID {
    // SAFETY: the caller passes a discriminant defined by FFmpeg.
...
impl From<AVCodecID> for Id {
    fn from(value: AVCodecID) -> Self {
        match value {
            ...
            #[cfg(feature = "ffmpeg_8_0")]
            _ if value as u32 == 275 => Id::JPEGXS,
            #[cfg(feature = "ffmpeg_8_0")]
            ...
            #[cfg(feature = "ffmpeg_8_0")]
            _ if value as u32 == 69686 => Id::ADPCM_IMA_HVQM4,
            #[cfg(feature = "ffmpeg_8_0")]
            _ if value as u32 == 69687 => Id::ADPCM_IMA_PDA,
            #[cfg(feature = "ffmpeg_8_0")]
            _ if value as u32 == 69688 => Id::ADPCM_N64,
            #[cfg(feature = "ffmpeg_8_0")]
            _ if value as u32 == 69689 => Id::ADPCM_IMA_HVQM2,
            #[cfg(feature = "ffmpeg_8_0")]
            _ if value as u32 == 69690 => Id::ADPCM_IMA_MAGIX,
            #[cfg(feature = "ffmpeg_8_0")]
            _ if value as u32 == 69691 => Id::ADPCM_PSXC,
            #[cfg(feature = "ffmpeg_8_0")]
            _ if value as u32 == 69692 => Id::ADPCM_CIRCUS,
            #[cfg(feature = "ffmpeg_8_0")]
            _ if value as u32 == 69693 => Id::ADPCM_IMA_ESCAPE,
            #[cfg(feature = "ffmpeg_8_0")]
            AV_CODEC_ID_G728 => Id::G728,
            #[cfg(feature = "ffmpeg_8_0")]
            _ if value as u32 == 86124 => Id::AHX,
            AV_CODEC_ID_IVTV_VBI => Id::IVTV_VBI,
            #[cfg(feature = "ffmpeg_8_0")]
            _ => match value as u32 {
                275 => Id::JPEGXS,
                69686 => Id::ADPCM_IMA_HVQM4,
                69687 => Id::ADPCM_IMA_PDA,
                69688 => Id::ADPCM_N64,
                69689 => Id::ADPCM_IMA_HVQM2,
                69690 => Id::ADPCM_IMA_MAGIX,
                69691 => Id::ADPCM_PSXC,
                69692 => Id::ADPCM_CIRCUS,
                69693 => Id::ADPCM_IMA_ESCAPE,
                86124 => Id::AHX,
                _ => Id::None,
            },
        }
...
impl From<Id> for AVCodecID {
    fn from(value: Id) -> AVCodecID {
        match value {
            ...
            #[cfg(feature = "ffmpeg_8_0")]
            Id::JPEGXS => codec_id_from_raw(275),
            #[cfg(feature = "ffmpeg_8_0")]
            ...
            #[cfg(feature = "ffmpeg_8_0")]
            Id::ADPCM_IMA_HVQM4 => codec_id_from_raw(69686),
            #[cfg(feature = "ffmpeg_8_0")]
            Id::ADPCM_IMA_PDA => codec_id_from_raw(69687),
            #[cfg(feature = "ffmpeg_8_0")]
            Id::ADPCM_N64 => codec_id_from_raw(69688),
            #[cfg(feature = "ffmpeg_8_0")]
            Id::ADPCM_IMA_HVQM2 => codec_id_from_raw(69689),
            #[cfg(feature = "ffmpeg_8_0")]
            Id::ADPCM_IMA_MAGIX => codec_id_from_raw(69690),
            #[cfg(feature = "ffmpeg_8_0")]
            Id::ADPCM_PSXC => codec_id_from_raw(69691),
            #[cfg(feature = "ffmpeg_8_0")]
            Id::ADPCM_CIRCUS => codec_id_from_raw(69692),
            #[cfg(feature = "ffmpeg_8_0")]
            Id::ADPCM_IMA_ESCAPE => codec_id_from_raw(69693),
            #[cfg(feature = "ffmpeg_8_0")]
            Id::G728 => AV_CODEC_ID_G728,
            #[cfg(feature = "ffmpeg_8_0")]
            Id::AHX => codec_id_from_raw(86124),

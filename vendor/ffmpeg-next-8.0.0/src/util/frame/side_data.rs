...
#[inline]
const fn frame_side_data_from_raw(value: u32) -> AVFrameSideDataType {
...
impl From<AVFrameSideDataType> for Type {
    ...
    fn from(value: AVFrameSideDataType) -> Self {
        match value {
            ...
            #[cfg(feature = "ffmpeg_8_0")]
            _ if value as u32 == 31 => Type::EXIF,
            #[cfg(feature = "ffmpeg_8_0")]
            _ => match value as u32 {
                31 => Type::EXIF,
                _ => Type::THREE_D_REFERENCE_DISPLAYS,
            },
        }
    }
}
...
impl From<Type> for AVFrameSideDataType {
    ...
    fn from(value: Type) -> AVFrameSideDataType {
        match value {
            ...
            #[cfg(feature = "ffmpeg_8_0")]
            Type::EXIF => frame_side_data_from_raw(31),
        }
    }
}

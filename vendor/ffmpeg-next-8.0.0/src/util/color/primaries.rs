...
#[inline]
const fn color_primaries_from_raw(value: u32) -> AVColorPrimaries {
...
impl From<AVColorPrimaries> for Primaries {
    fn from(value: AVColorPrimaries) -> Primaries {
        match value {
            ...
            #[cfg(feature = "ffmpeg_8_0")]
            _ if value as u32 == 256 => Primaries::VGamut,
            #[cfg(feature = "ffmpeg_8_0")]
            _ if value as u32 == 257 => Primaries::Reserved0,
            #[cfg(not(feature = "ffmpeg_4_3"))]
            ...
            _ => match value as u32 {
                256 => Primaries::VGamut,
                257 => Primaries::Reserved0,
...
impl From<Primaries> for AVColorPrimaries {
    fn from(value: Primaries) -> AVColorPrimaries {
        match value {
            ...
            #[cfg(feature = "ffmpeg_8_0")]
            Primaries::VGamut => color_primaries_from_raw(256),
            #[cfg(not(feature = "ffmpeg_4_3"))]

...
#[inline]
const fn color_transfer_from_raw(value: u32) -> AVColorTransferCharacteristic {
...
impl From<AVColorTransferCharacteristic> for TransferCharacteristic {
    fn from(value: AVColorTransferCharacteristic) -> TransferCharacteristic {
        match value {
            ...
            #[cfg(feature = "ffmpeg_8_0")]
            _ if value as u32 == 256 => TransferCharacteristic::VLog,
            #[cfg(feature = "ffmpeg_8_0")]
            _ if value as u32 == 257 => TransferCharacteristic::Reserved0,
            #[cfg(feature = "ffmpeg_8_0")]
            _ => match value as u32 {
                256 => TransferCharacteristic::VLog,
                257 => TransferCharacteristic::Reserved0,
...
impl From<TransferCharacteristic> for AVColorTransferCharacteristic {
    fn from(value: TransferCharacteristic) -> AVColorTransferCharacteristic {
        match value {
            ...
            #[cfg(feature = "ffmpeg_8_0")]
            TransferCharacteristic::VLog => color_transfer_from_raw(256),
        }
    }
}

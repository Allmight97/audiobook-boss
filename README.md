...
- For external library/API behavior, use `.agents/skills/abb-library-research` to route authenticated Context7/current docs, squashed `repos/*` reference source, and installed dependency truth. Reference repos are read-only research material, not app dependencies.

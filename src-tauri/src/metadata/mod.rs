...
pub use cover_session::{
    cover_art_view_for_display, hydrate_intent_map, stage_cover_art, CoverArtView, CoverStash,
    IpcMetadataIntentPatch, IpcMetadataIntentValidationResult,
};
